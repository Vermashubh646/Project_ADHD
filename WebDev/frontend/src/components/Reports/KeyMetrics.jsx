...
const KeyMetrics = ({ sessions }) => {
  ...
  return (
    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 mt-4">
      <div className="p-4 bg-blue-100 border border-blue-300 text-blue-900 shadow-sm">
        <h3 className="font-semibold text-sm">Total Focus Time</h3>
        <p className="text-lg font-bold">{formatTime(metrics.totalFocusTime)}</p>
      </div>
      <div className="p-4 bg-green-100 border border-green-300 text-green-900 shadow-sm">
      ...
      <div className="p-4 bg-yellow-100 border border-yellow-300 text-yellow-900 shadow-sm">
        <h3 className="font-semibold text-sm">Total Tasks Completed</h3>
        <p className="text-lg font-bold">{metrics.totalTasksCompleted}</p>
      </div>
      <div className="p-4 bg-red-100 border border-red-300 text-red-900 shadow-sm">
      ...
      <div className="p-4 bg-purple-100 border border-purple-300 text-purple-900 shadow-sm">
